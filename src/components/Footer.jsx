            ...
            <div className="footer-container">
                ...
                <div className="footer-grid-container">
                    ...
                    <ul className="footer__grid-item footer__grid-item--education">
                        <li className="lists-item">Education</li>
                    ...
                    <div className="footer__grid-item footer__grid-item--lang&loc">
                        <div><strong>Language and Location</strong></div>
                        <select
                            className="lang"
                        >
